...
lambda = 0.75/zeta;
%% importen matcam
datamat = load('rigidbodyforces_withecc.mat');
lift = datamat.S(20000:22000)*0.001;
time = datamat.theta(20000:22000)/datamat.w;
T = (2*pi)/datamat.w;
m = datamat.mass;
t =  time-time(1);
...
%% theta
theta = (lift-0.0125)/0.0025;  %van 1 naar 0
%% simulatie met beginvoorwaarden
theta0 = 1; % vul hier zelf de initiele dimensieloze heffing in
theta_dot0 = -100; % vul hier zelf de initiele dimensieloze snelheid in
